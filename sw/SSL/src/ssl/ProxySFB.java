...
public class ProxySFB extends FSM implements IFSM {
	...
	public void init() {
		...
		parameters.add(new Parameter("MATCH_ACTION_TABLE.R0.COUNTER", Parameter.MATCH_ACTION_TABLE_BASE_ADDR, 0x000, 0x24, false, true));
		...
		t1 = new Timer(SSL.PROXYSFB, this, 10, new Message(Message.TIMER_EXPIRED));
	}
